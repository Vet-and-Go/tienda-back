...
class ProductRepositoryImplTest {
   ...
   * // Arrange
   * CategoryJpaEntity categoryEntity = new CategoryJpaEntity(1L, "Alimentos",
   * "Comida para mascotas");
   * ProductJpaEntity entity = new ProductJpaEntity(1L, "Dog Food",
   * categoryEntity, "Premium dog food", new BigDecimal("29.99"), 100, new
   * BigDecimal("0.00"), new BigDecimal("29.99"), "url");
   ...
   * 
   * // Act
   * Optional<ProductJpaEntity> result =
   * productRepository.findByName("Unknown Product");
   * 
   * // Assert
   ...
   * CategoryJpaEntity categoryEntity = new CategoryJpaEntity(1L, "Alimentos",
   * "Comida para mascotas");
   * ProductJpaEntity newEntity = new ProductJpaEntity(null, "Dog Food",
   * categoryEntity, "Premium dog food", new BigDecimal("29.99"), 100, new
   * BigDecimal("0.00"), new BigDecimal("29.99"), "url");
   * ProductJpaEntity savedEntity = new ProductJpaEntity(1L, "Dog Food",
   * categoryEntity, "Premium dog food", new BigDecimal("29.99"), 100, new
   * BigDecimal("0.00"), new BigDecimal("29.99"), "url");
   * when(productJpaDao.insert(any(ProductJpaEntity.class))).thenReturn(
   * savedEntity);
   * 
   * // Act
   ...
   * CategoryJpaEntity categoryEntity = new CategoryJpaEntity(1L, "Alimentos",
   * "Comida para mascotas");
   * ProductJpaEntity existingEntity = new ProductJpaEntity(1L,
   * "Dog Food Premium", categoryEntity, "Premium dog food", new
   * BigDecimal("39.99"), 150, new BigDecimal("0.00"), new BigDecimal("39.99"),
   * "url");
   * when(productJpaDao.update(any(ProductJpaEntity.class))).thenReturn(
   * existingEntity);
   * 
   * // Act
   ...
   * CategoryJpaEntity categoryEntity = new CategoryJpaEntity(1L, "Alimentos",
   * "Comida para mascotas");
   * ProductJpaEntity entity1 = new ProductJpaEntity(1L, "Dog Food",
   * categoryEntity, "Premium dog food", new BigDecimal("29.99"), 100, new
   * BigDecimal("0.00"), new BigDecimal("29.99"), "url");
   * ProductJpaEntity entity2 = new ProductJpaEntity(2L, "Cat Food",
   * categoryEntity, "Premium cat food", new BigDecimal("24.99"), 150, new
   * BigDecimal("0.00"), new BigDecimal("24.99"), "url");
   * List<ProductJpaEntity> productList = Arrays.asList(entity1, entity2);
   * 
   * when(productJpaDao.findAll(page, size, null, null,
   * null)).thenReturn(productList);
   * when(productJpaDao.count()).thenReturn(2L);
   * 
   * // Act
   * Page<ProductJpaEntity> result = productRepository.getAll(page, size, null,
   * null, null);
   * 
   * // Assert
   * assertNotNull(result);
